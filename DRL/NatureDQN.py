...
class NatureDQN(DRL):
    def __init__(self, sess,  scope, globalAC=None):
        ...
        self.lr = cfg['NatureDQN']['LR']
        self.gamma = cfg['NatureDQN']['GAMMA']
        self.e_greedy = cfg['NatureDQN']['E_GREEDY']
        self.update_nn_step = cfg['NatureDQN']['UPDATE_NN_STEP']
        self.memory_size = cfg['NatureDQN']['MENORY_SIZE']
        self.batch_size = cfg['NatureDQN']['BATCH_SIZE']

        if scope != cfg['NatureDQN']['main_net_scope']:
